...
var homesteadReward = math.MustParseBig256("20000000000000000000")
var byzantiumReward = math.MustParseBig256("20000000000000000000")
...
func NewBlockUnlocker(cfg *UnlockerConfig, backend *storage.RedisClient) *BlockUnlocker {
	...
	// FUNCOIN Network
	if block.Hash == "0x06b7ce303afa857fb5b773e25fac07d1a59d9bb56739d54f507d9e5e713ec6eef" {
		log.Printf("Found genesis.hash is %v", block.Hash)
		byzantiumHardForkHeight = 600000
		homesteadReward = math.MustParseBig256("20000000000000000000")
		byzantiumReward = math.MustParseBig256("20000000000000000000")
